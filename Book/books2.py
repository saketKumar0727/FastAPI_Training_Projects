...
BOOKS = [
    Book(1,'Computer Science Pro','codingwithsaket','A very nice book!',5,2022),
    Book(2,'Be Fast with FastAPI','codingwithsaket','A great book!',5,2025),
    Book(3,'Master Endpoints','codingwithsaket','A awesome book!',5,2022),
